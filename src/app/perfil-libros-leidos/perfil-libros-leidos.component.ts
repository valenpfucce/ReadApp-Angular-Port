...
@Component({
  ...
  styleUrls: ['../estilos_generales/estilo_recomendacion.css', '../pag-detalle-recomendacion/pag-detalle-recomendacion.component.css', '../card-libro/card-libro.component.css', '../perfil-amigos/perfil-amigos.component.css', './perfil-libros-leidos.component.css']
})
