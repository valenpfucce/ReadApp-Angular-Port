...
export class PagDetalleRecomendacionComponent {
  ...
  cardLibros = [
    ...
    new CardLibro('Don Quijote de la mancha','Miguel de Cervantes', 'https://www.planetalector.com/usuaris/thumbnails/libros/fotos/374/360/portada_don-quijote-de-la-mancha-comic_miguel-de-cervantes_202310231106.jpg',102,60504,['Español','Inglés'],9802),
